...
class CaracteristicasTest < ApplicationSystemTestCase
  ...
  test "creating a Caracteristica" do
    ...
    fill_in "Caracteristica", with: @caracteristica.caracteristica
    fill_in "Caracterizacion", with: @caracteristica.caracterizacion_id
    fill_in "Tipo", with: @caracteristica.tipo
