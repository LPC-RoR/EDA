...
class EtapasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create etapa" do
    assert_difference('Etapa.count') do
      post etapas_url, params: { etapa: { etapa: @etapa.etapa, orden: @etapa.orden, proyecto_id: @etapa.proyecto_id } }
    end
  ...
  test "should update etapa" do
    patch etapa_url(@etapa), params: { etapa: { etapa: @etapa.etapa, orden: @etapa.orden, proyecto_id: @etapa.proyecto_id } }
