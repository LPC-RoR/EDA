...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post documentos_url, params: { documento: { documento: @documento.documento, proyecto_id: @documento.proyecto_id } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { documento: @documento.documento, proyecto_id: @documento.proyecto_id } }
