...
class MetodologiasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metodologia" do
    assert_difference('Metodologia.count') do
      post metodologias_url, params: { metodologia: { metodologia: @metodologia.metodologia, orden: @metodologia.orden, publicacion_id: @metodologia.publicacion_id } }
    end
  ...
  test "should update metodologia" do
    patch metodologia_url(@metodologia), params: { metodologia: { metodologia: @metodologia.metodologia, orden: @metodologia.orden, publicacion_id: @metodologia.publicacion_id } }
