...
class ArchivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post archivos_url, params: { archivo: { archivo: @archivo.archivo, nota: @archivo.nota, orden: @archivo.orden } }
    end
  ...
  test "should update archivo" do
    patch archivo_url(@archivo), params: { archivo: { archivo: @archivo.archivo, nota: @archivo.nota, orden: @archivo.orden } }
