...
class CitasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cita" do
    assert_difference('Cita.count') do
      post citas_url, params: { cita: { publicacion_id: @cita.publicacion_id, texto_id: @cita.texto_id } }
    end
  ...
  test "should update cita" do
    patch cita_url(@cita), params: { cita: { publicacion_id: @cita.publicacion_id, texto_id: @cita.texto_id } }
