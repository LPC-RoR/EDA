...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { departamento: @departamento.departamento, institucion_id: @departamento.institucion_id } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { departamento: @departamento.departamento, institucion_id: @departamento.institucion_id } }
