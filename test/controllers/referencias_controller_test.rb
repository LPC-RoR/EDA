...
class ReferenciasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create referencia" do
    assert_difference('Referencia.count') do
      post referencias_url, params: { referencia: { concepto_id: @referencia.concepto_id, publicacion_id: @referencia.publicacion_id } }
    end
  ...
  test "should update referencia" do
    patch referencia_url(@referencia), params: { referencia: { concepto_id: @referencia.concepto_id, publicacion_id: @referencia.publicacion_id } }
