...
class RevistasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create revista" do
    assert_difference('Revista.count') do
      post revistas_url, params: { revista: { idioma_id: @revista.idioma_id, revista: @revista.revista } }
    end
  ...
  test "should update revista" do
    patch revista_url(@revista), params: { revista: { idioma_id: @revista.idioma_id, revista: @revista.revista } }
