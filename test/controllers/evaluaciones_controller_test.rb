...
class EvaluacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluaciones_url, params: { evaluacion: { conclusion: @evaluacion.conclusion, metodologia: @evaluacion.metodologia, objetivo: @evaluacion.objetivo, publicacion_id: @evaluacion.publicacion_id, resultado: @evaluacion.resultado } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { conclusion: @evaluacion.conclusion, metodologia: @evaluacion.metodologia, objetivo: @evaluacion.objetivo, publicacion_id: @evaluacion.publicacion_id, resultado: @evaluacion.resultado } }
